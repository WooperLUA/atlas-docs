...
export const IntroView = () => Layout(
    Section({},
        ...
        P({ textContent: 'The framework is divided into three specialized packages, allowing you to use only what you need.' }),
        
        H2({ textContent: '📦 Three Pillars' }),
        Div({ className: 'feature-grid' },
            Div({ className: 'feature-card' }, 
                H3({ textContent: 'atlas' }), 
